...
namespace DV\ProfitMetrics\Controller\Adminhtml\Random;
...
/**
 * Class CodeGenerate
 * @package DV\ProfitMetrics\Controller\Adminhtml\Random
 */
class CodeGenerate extends Action implements HttpGetActionInterface, HttpPostActionInterface
{
    const ADMIN_RESOURCE = 'DV_ProfitMetrics::random_code';
