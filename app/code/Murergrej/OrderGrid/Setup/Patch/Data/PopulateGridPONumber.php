...
class PopulateGridPONumber implements DataPatchInterface
{
    /**
    ...
    private function populateSalesOrderGridColumns()
    {
        ...
        foreach ($gridTables as $table) {
            ...
            $select = $connection->select()->join(
                $connection->getTableName('sales_order_payment'),
                sprintf("sales_order_payment.parent_id = %s.entity_id", $table),
                ['po_number']
            );
