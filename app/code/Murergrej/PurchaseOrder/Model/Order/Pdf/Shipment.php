...
namespace Murergrej\PurchaseOrder\Model\Order\Pdf;
...
class Shipment extends \Magento\Sales\Model\Order\Pdf\Shipment
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if ($this->isCreditLimit($order)) {
            $dateText .= '     ' . __('HOLD ORDER DUE TO CREDIT LIMIT');

            $page->setFillColor(new \Zend_Pdf_Color_Rgb(255, 0, 0));
            $page->drawRectangle(145, $top - 2, 327, $top + 8);
            $page->setFillColor(new \Zend_Pdf_Color_GrayScale(1));
        }
        $page->drawText(
            $dateText,
    ...
    protected function isCreditLimit(\Magento\Sales\Model\Order $order)
    {
