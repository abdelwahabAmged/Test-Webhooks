...
namespace Scandiweb\MenuOrganizer\Console\Command;
...
class MenuGenerateCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $categoriesCollection->addFieldToFilter('is_active', 1);
//        $categoriesCollection->addFieldToFilter('include_in_menu', 1);
        $categoriesCollection->addAttributeToSort('level', 'asc');
    ...
    public function createMenuItem($category)
    {
        ...
        $data = [
            ...
            'url_type' => '2', // 2 for URL type Category, 0 for Custom url
            'url' => '/' . $this->categoryUrlPathGenerator->getUrlPathWithSuffix($category),
    ...
    public function isCategoryAvailable($category)
    {
        if ($category->getLevel() == 1) {
            return false; // Exclude root categories
        }

        if (in_array($category->getName(), $this->rootCategories) || $category->getLevel() > 5) {
            return false;
        }
