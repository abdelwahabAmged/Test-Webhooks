...
return [
    'modules' => [
        ...
        'Amasty_Shiprules' => 1,
        'Amasty_ShippingRulesHyva' => 1,
        'Hyva_Theme' => 1,
        'Apsis_One' => 1,
        'Cynoinfotech_ShippingRestrictions' => 1,
        'DV_ProfitMetrics' => 1,
        ...
        'Murergrej_AddressFormat' => 1,
        'Murergrej_Backend' => 1,
        'Murergrej_BrandWidget' => 1,
        'Murergrej_Catalog' => 1,
        'Murergrej_CatalogLabel' => 1,
        'Murergrej_Category' => 1,
        'Murergrej_Checkout' => 1,
        'Murergrej_CheckoutRest' => 1,
        'Murergrej_CmsBlocks' => 1,
        'Murergrej_ConfigurableProduct' => 1,
        'Murergrej_Contact' => 1,
        'Murergrej_CookieBanner' => 1,
        'Murergrej_Core' => 1,
        'Murergrej_Customer' => 1,
        'Murergrej_Eav' => 1,
        'Murergrej_Emarket' => 1,
        'Murergrej_Footer' => 1,
        'Murergrej_GroupedProduct' => 1,
        'Murergrej_Gtm' => 1,
        'Murergrej_HelloRetail' => 1,
        'Murergrej_Hyva' => 1,
        'Murergrej_Import' => 1,
        'Murergrej_InvoiceEmail' => 1,
        'WebShopApps_MatrixRate' => 1,
        'Murergrej_OrderGrid' => 1,
        'Murergrej_PallePant' => 1,
        'Murergrej_PalletShipping' => 1,
        'Murergrej_PickupLocatorShippingMethodsFramework' => 1,
        'Murergrej_ProductVideo' => 1,
        'Murergrej_PurchaseOrder' => 1,
        'Murergrej_PurchaseOrderLength' => 1,
        'Murergrej_Reservations' => 1,
        'Murergrej_Sales' => 1,
        'Murergrej_Stock' => 1,
        'Murergrej_Tax' => 1,
        'Murergrej_Theme' => 1,
        'Murergrej_Tracking' => 1,
        'OlegKoval_RegenerateUrlRewrites' => 1,
        'PWA_Banner' => 0,
        'PWA_Base' => 0,
        'PWA_Cache' => 0,
        'PWA_Contact' => 0,
        'PWA_FixProductRenderApi' => 0,
        'PWA_FrontendRedirect' => 0,
        'PWA_Gtm' => 0,
        'PWA_Import' => 0,
        'PWA_OrderComment' => 0,
        'PWA_PriceShape' => 0,
        ...
        'Scandiweb_HyvaUi' => 1,
        'Scandiweb_Mageworx' => 1,
        'Scandiweb_MenuOrganizerExtension' => 1,
        'Scandiweb_MenuOrganizer' => 1,
        'Scandiweb_Migration' => 1,
        'Scandiweb_StyleGuide' => 1,
        'Swiipe_Checkout' => 1,
        'Temando_ShippingRemover' => 1,
        'Trustpilot_Reviews' => 1,
        'Vconnect_PickupLocatorShippingMethodsFramework' => 1,
        'Vconnect_PickupLocator' => 1,
        'Vconnect_PickupLocatorCheckoutFrontend' => 1,
        'Vconnect_PickupLocatorSearchApi' => 1,
        'Vconnect_PickupLocatorAdminUi' => 1,
        'Vconnect_PostNordPickupLocatorSearch' => 1,
        'Vconnect_PostNord' => 1,
        'Murergrej_MatrixRate' => 1
    ],
    'scopes' => [
        'websites' => [
            'admin' => [
